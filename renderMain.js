            ...
            var planets_distance = [0.39, 0.72 , 1.0 , 1.52  , 5.0 , 15, 19.2 , 30.5];//태양으로 부터의 거리 AU
            ...
            {     
                ...
                screen_object.perspective_fov_LH(PI/180 * 60 , window.innerWidth/window.innerHeight - 0.07 , 1 , 500.0 );
            ...
            function mouse_cam_trackball(view_cam_obj, canvas ,start_p_v2f , cur_p_v2f)
            {
                ...
                pre_pos_v4f = [ view_cam_obj.pos_v4f[0] ,  view_cam_obj.pos_v4f[1] ,  view_cam_obj.pos_v4f[2] , 1.0];
                view_cam_obj.pos_v4f[0]= pre_pos_v4f[0] * rotate_mat4[0] + pre_pos_v4f[1] * rotate_mat4[1]  + pre_pos_v4f[2] * rotate_mat4[2]; 
                view_cam_obj.pos_v4f[1]= pre_pos_v4f[0] * rotate_mat4[4] + pre_pos_v4f[1] * rotate_mat4[5]  + pre_pos_v4f[2] * rotate_mat4[6]; 
                view_cam_obj.pos_v4f[2]= pre_pos_v4f[0] * rotate_mat4[8] + pre_pos_v4f[1] * rotate_mat4[9]  + pre_pos_v4f[2] * rotate_mat4[10];   
